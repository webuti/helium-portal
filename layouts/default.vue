        ...
        <div id="tabs" class="flex justify-between">
          ...
          >
            <span class="flex flex-col items-center p-2">
              ...
              <span class="tab tab-account block text-xs">{{ $t('countries') }}</span>
            </span></nuxt-link
          >
          <nuxt-link
            class="
          ...
          >
            <span class="flex flex-col items-center p-2">
              ...
              <span class="tab tab-account block text-xs">{{ $t('top100') }}</span>
            </span></nuxt-link
          >
          ...
          >
            <span class="flex flex-col items-center p-2">
              ...
              <span class="tab tab-account block text-xs">{{ $t('telegram') }}</span>
            </span></nuxt-link
          >
          <nuxt-link
            class="
          ...
          >
            <span class="flex flex-col items-center p-2">
              ...
              <span class="tab tab-account block text-xs">{{ $t('about') }}</span>
            </span></nuxt-link
          >
        </div>
      </section>
